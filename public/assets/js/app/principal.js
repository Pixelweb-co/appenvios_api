//conectar socket 
  ...
  var socket = io('http://192.168.0.3', {query: {tipo:'cliente', cliente:localStorage.getItem('user_id')}});
...
app.controller('solController', ['$scope', '$http', function ($scope, $http) {
    ...
    //data usuario
       $scope.obtener_usuario = function () {
        $http.post('http://192.168.0.3/api/obtener_usuario', {user:localStorage.getItem('user_id')})
...
$scope.obtener_usuario();
    ...
    //data ofertas
       $scope.obtener_ofertas = function (sol_id) {
        $http.post('http://192.168.0.3/api/obtener_ofertas', {solicitud:sol_id})
            .then(function success(e) {
    ...
    $scope.obtener_ofertas_user = function (user_id) {
        $http.post('http://192.168.0.3/api/obtener_ofertas_user', {user:user_id})
            .then(function success(e) {
    ...
    //data chat
       $scope.listchat = function (sol_id) {
        $http.post('http://192.168.0.3/api/mensajes', {solicitud:sol_id})
            .then(function success(e) {
...
$scope.listsolicitudes = function () {
        $http.post('http://192.168.0.3/api/solicitudes_user', {user:localStorage.getItem('user_id'),estado:'Abierta'})
            .then(function success(e) {
    ...
    $scope.listsolicitudes_activas = function () {
        $http.post('http://192.168.0.3/api/solicitudes_user', {user:localStorage.getItem('user_id'),estado:'En curso'})
            .then(function success(e) {
    ...
    $scope.listsolicitudes_completadas = function () {
         $http.post('http://192.168.0.3/api/solicitudes_user', {user:localStorage.getItem('user_id'),estado:'Cerrada'})
            .then(function success(e) {
    ...
    $scope.contratistaSel = function (ids) {
        $http.post('http://192.168.0.3/api/obtener_contratista', {id:ids})
            .then(function success(e) {
    ...
    $scope.acetarOferta = function (ids) {
        $http.post('http://192.168.0.3/api/aceptar_oferta', {id:ids})
            .then(function success(e) {
    ...
    $scope.ObtenerOferta = function (ids) {
        $http.post('http://192.168.0.3/api/obtener_oferta', {id:ids})
            .then(function success(e) {
