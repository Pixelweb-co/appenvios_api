...
To test the result go to **playground**, start server <code>node server.js</code> and open in your browser [http://iwebsuite.com:3000/playground](http://iwebsuite.com:3000/playground).
